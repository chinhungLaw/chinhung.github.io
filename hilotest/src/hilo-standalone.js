    ...
    var e = function () {
        ...
        return {
            getUid: function (t) {
                ...
                try {
                    var a = "hilo";
                    localStorage.setItem(a, a), localStorage.removeItem(a), e.supportStorage = !0
                } catch (s) {}
                ...
                return d && (l.id = "test3d", c = n.createElement("style"), c.textContent = "@media (" + h + "transform-3d){#test3d{height:3px}}", n.head.appendChild(c), r.appendChild(l), d = 3 == l.offsetHeight, n.head.removeChild(c), r.removeChild(l)), e.supportTransform = u, e.supportTransform3D = d, e
            }(),
            event: function () {
            ...
            getElementRect: function (t) {
                ...
                if (this.cacheStateIfChanged(t, ["visible"], r) && (n.display = t.visible ? "" : "none"), this.cacheStateIfChanged(t, ["alpha"], r) && (n.opacity = t.alpha), t.visible && !(t.alpha <= 0)) {
                    ...
                    if (f) {
                        ...
                        var v = f.x,
                            m = f.y;
                        (v !== r.maskX || m !== r.maskY) && (r.maskX = v, r.maskY = m, n[a + "MaskPosition"] = v + s + " " + m + s)
                    }
                }
    ...
    var e = t.Hilo,
        i = function () {
            var t = function (t) {
                ...
                i = {
                    Extends: function (t) {
                        var e = this.prototype,
                            i = n(t.prototype);
                        r(this, t), r(i, e), i.constructor = this, this.prototype = i, this.superclass = t.prototype
                    }, Mixes: function (t) {
                        t instanceof Array || (t = [t]);
                        for (var e, i = this.prototype; e = t.shift();) r(i, e.prototype || e)
                    }, Statics: function (t) {
                        r(this, t)
                    }
                },
                ...
                r = function (t) {
                    for (var e = 1, i = arguments.length; i > e; e++) {
                        ...
                        for (var a in r) {
                            var o = r[a];
                            !o || "object" != typeof o || void 0 === o.value && "function" != typeof o.get && "function" != typeof o.set ? t[a] = o : (n = n || {}, n[a] = o)
                        }
                        n && s(t, n)
                    }
                    return t
            ...
            try {
                ...
                "__defineGetter__" in Object && (a = function (t, e, i) {
    ...
    var e = t.Hilo,
        ...
        n = i.create({
            constructor: function (t, e, i, n, r, a) {
                ...
                return this.a = i * h + n * c, this.b = i * l + n * u, this.c = r * h + a * c, this.d = r * l + a * u, this.tx = s * h + o * c + d, this.ty = s * l + o * u + f, this
            }, rotate: function (t) {
                var e = Math.sin(t),
                    i = Math.cos(t),
                    n = this.a,
                    ...
                    o = this.tx,
                    h = this.ty;
                return this.a = n * i - r * e, this.b = n * e + r * i, this.c = a * i - s * e, this.d = a * e + s * i, this.tx = o * i - h * e, this.ty = o * e + h * i, this
            }, scale: function (t, e) {
    ...
    var e = t.Hilo,
        ...
        n = {
            ...
            on: function (t, e, i) {
                ...
                var i, n;
                "string" == typeof t ? n = t : (i = t, n = t.type);
                ...
                if ("string" == typeof a) {
                    if (!r || a !== r.getAttribute("src")) {
                        ...
                        return s.onload = function () {
                            s.onload = null, i.init(s)
                        }, void(s.src = a)
                    }
                    a = i.image = r
                }
                a && !i.rect && (i.rect = [0, 0, a.width, a.height])
            }, Statics: {
...
function (t) {
    var e = t.Hilo,
        ...
        n = i.create({
            ...
            canvas: null,
            stage: null,
            startDraw: function (t) {}, draw: function (t) {}, endDraw: function (t) {}, transform: function () {}, hide: function () {}, remove: function (t) {}, clear: function (t, e, i, n) {}, resize: function (t, e) {}
        });
    e.Renderer = n
}(window),
function (t) {
    var e = t.Hilo,
        ...
        r = i.create({
            ...
            startDraw: function (t) {
                return t.visible && t.alpha > 0 ? (t === this.stage && this.context.clearRect(0, 0, t.width, t.height), this.context.save(), !0) : !1
            }, draw: function (t) {
                var e = this.context,
                    i = t.width,
                    n = t.height,
                ...
                if (s) {
                    var o = a.rect,
                        ...
                        u = o[5];
                    if (!h || !l) return;
                    i || n || (i = t.width = h, n = t.height = l), (c || u) && e.translate(c - .5 * h, u - .5 * l), e.drawImage(s, o[0], o[1], h, l, 0, 0, i, n)
                }
            }, endDraw: function (t) {
                ...
                if (t === this.stage) {
                    var s = this.canvas.style,
                        o = t._scaleX,
                        h = t._scaleY;
                    (!o && 1 != r || o && o != r) && (t._scaleX = r, s.width = r * t.width + "px"), (!h && 1 != a || h && h != a) && (t._scaleY = a, s.height = a * t.height + "px")
                } else {
                    var l = t.x,
                        c = t.y,
                        u = t.pivotX,
                    ...
                    if (v)
                        ...
                        }(0 != l || 0 != c) && n.translate(l, c), 0 != f && n.rotate(f * Math.PI / 180), (1 != r || 1 != a) && n.scale(r, a), (0 != u || 0 != d) && n.translate(-u, -d)
                }
                ...
                if (t.id && (o.id = t.id), h.position = "absolute", h.left = (t.left || 0) + "px", h.top = (t.top || 0) + "px", h.width = a + "px", h.height = s + "px", "canvas" == n) {
                    if (o.width = a, o.height = s, r) {
                        var l = o.getContext("2d"),
                            c = i.rect || [0, 0, a, s];
                        l.drawImage(r, c[0], c[1], c[2], c[3], t.x || 0, t.y || 0, t.width || c[2], t.height || c[3])
                    }
                } else if (h.opacity = void 0 != t.alpha ? t.alpha : 1, (t === this.stage || t.clipChildren) && (h.overflow = "hidden"), r && r.src) {
                    h.backgroundImage = "url(" + r.src + ")";
                    var u = t.rectX || 0,
                        d = t.rectY || 0;
                ...
                startDraw: function (e) {
                    ...
                    if (e.setElementStyleByView(t), t === this.stage) {
                        var i = this.canvas.style,
                            ...
                            a = t.scaleX,
                            s = t.scaleY;
                        (!n && 1 != a || n && n != a) && (t._scaleX = a, i.width = a * t.width + "px"), (!r && 1 != s || r && r != s) && (t._scaleY = s, i.height = s * t.height + "px")
                    }
                }, remove: function (t) {
                    var e = t.drawable,
                        i = e && e.domElement;
...
function (t) {
    var e = t.Hilo,
        ...
        s = i.create({
            ...
            constructor: function (e) {
                t.__render = this, s.superclass.constructor.call(this, e);
            ...
            startDraw: function (t) {
                return t.visible && t.alpha > 0 ? (t === this.stage && this.clear(), !0) : !1
            }, draw: function (t) {
                ...
                if (r) {
                    ...
                    t.texture = r.texture, this.sprites[this.batchIndex++] = t
                }
            }, endDraw: function (t) {
                ...
                if (t === this.stage) {
                    var s = this.canvas.style,
                        o = t._scaleX,
                        h = t._scaleY;
                    (!o && 1 != n || o && o != n) && (t._scaleX = n, s.width = n * t.width + "px"), (!h && 1 != a || h && h != a) && (t._scaleY = a, s.height = a * t.height + "px"), t.__webglWorldMatrix = t.__webglWorldMatrix || new r(1, 0, 0, 1, 0, 0)
                } else t.__webglWorldMatrix = t.__webglWorldMatrix || new r(1, 0, 0, 1, 0, 0), this._setConcatenatedMatrix(t, t.parent);
                ...
                (this.width !== t || this.height !== e) && (this.width = this.canvas.width = t, this.height = this.canvas.height = e, this.gl.viewport(0, 0, t, e), this.canvasHalfWidth = .5 * t, this.canvasHalfHeight = .5 * e, this._uploadProjectionTransform(!0))
                ...
                var i = this.gl,
                    n = e - t;
                n > 0 && (i.bindTexture(i.TEXTURE_2D, this.sprites[t].texture), i.drawElements(i.TRIANGLES, 6 * n, i.UNSIGNED_SHORT, 6 * t * 2))
            ...
            }, _createVertexs: function (t, e, i, n, r, a, s, o, h) {
                var l = this.__tempVertexs || [],
                    c = t.width,
                    u = t.height;
                n /= c, r /= u, e /= c, i /= u, o = o, h = h, a = a, s = s, n + e > 1 && (n = 1 - e), r + i > 1 && (r = 1 - i);
                var d = 0;
                return l[d++] = a, l[d++] = s, l[d++] = e, l[d++] = i, l[d++] = a + o, l[d++] = s, l[d++] = e + n, l[d++] = i, l[d++] = a, l[d++] = s + h, l[d++] = e, l[d++] = i + r, l[d++] = a + o, l[d++] = s + h, l[d++] = e + n, l[d++] = i + r, l
    ...
    }, s.isSupport = function () {
        if (void 0 !== this._isSupport) return this._isSupport;
        var t = document.createElement("canvas");
        return t.getContext && (t.getContext("webgl") || t.getContext("experimental-webgl")) ? this._isSupport = !0 : this._isSupport = !1, this._isSupport
    }, e.WebGLRenderer = s
}(window),
function (t) {
    var e = t.Hilo,
        ...
        a = function () {
            ...
            function s(t, e, i) {
                for (var n, r, a, s, o, h, l, c, u, d = t.length, f = e.length, p = {
                    x: 0,
                    y: 0
                }, v = 0; d > v; v++) {
                    n = t[v], r = t[d - 1 > v ? v + 1 : 0], p.x = n.y - r.y, p.y = r.x - n.x, a = Math.sqrt(p.x * p.x + p.y * p.y), p.x /= a, p.y /= a, s = o = t[0].x * p.x + t[0].y * p.y;
            ...
            return i.create({
                ...
                getStage: function () {
                    ...
                    for (var t, e, i, n, r, a, s, o = this.width, h = this.height, l = this.getConcatenatedMatrix(), c = this.boundsArea || [{
                        x: 0,
                        y: 0
                    }, {
                        x: o,
                        ...
                        x: 0,
                        y: h
                    }], u = [], d = 0, f = c.length; f > d; d++) t = l.transformPoint(c[d], !0, !0), e = t.x, i = t.y, 0 == d ? (n = r = e, a = s = i) : (n > e ? n = e : e > r && (r = e), a > i ? a = i : i > s && (s = i)), u[d] = t;
                    return u.x = n, u.y = a, u.width = r - n, u.height = s - a, u
                    ...
                    var n = this.parent;
                    t._stopped || t._stopPropagationed || !n || ("mouseout" == t.type || "touchout" == t.type ? n.hitTestPoint(t.stageX, t.stageY, !0) || n._fireMouseEvent(t) : n._fireMouseEvent(t))
                }, onUpdate: null,
                render: function (t, e) {
                    t.draw(this)
                }, toString: function () {
    ...
    var e = t.Hilo,
        ...
        a = {
            ...
            cache: function (t) {
                ...
                n.width = this.width, n.height = this.height, this._draw(r), this._cacheImage = new Image, this._cacheImage.src = n.toDataURL(), this.drawable = this.drawable || new i, this.drawable.init(this._cacheImage), this._cacheDirty = !1
    ...
    var e = t.Hilo,
        ...
        r = i.create({
            ...
            getNumChildren: function () {
                ...
                for (var i, n = this.children, t = t || 0, e = e || n.length, r = t; e > r; r++) i = n[r], i.depth = r + 1, i.parent = this
            }, contains: function (t) {
                for (; t = t.parent;)
                    if (t === this) return !0;
                return !1
...
function (t) {
    var e = t.Hilo,
        ...
        o = i.create({
            Extends: n,
            constructor: function (t) {
                t = t || {}, this.id = this.id || t.id || e.getUid("Stage"), o.superclass.constructor.call(this, t), this._initRenderer(t);
                var i = this.width,
                    n = this.height,
            ...
            _initRenderer: function (t) {
                ...
                for (var i = this, n = i.canvas, r = "string" == typeof t ? [t] : t, e = e !== !1, a = i._domListener || (i._domListener = function (t) {
                    i._onDOMEvent(t)
                }), s = 0; s < r.length; s++) {
                    var t = r[s];
                ...
                n.stageX = h = (h - c.left) / this.scaleX, n.stageY = l = (l - c.top) / this.scaleY, n.stopPropagation = function () {
                ...
                e.browser.android && "touchmove" === i && t.preventDefault()
        ...
        a = i.create({
            ...
            constructor: function (t) {
                ...
                return this.drawable.init({
                    image: t,
                    rect: e
                }), e && (this.width = e[2], this.height = e[3]), this
            }
        });
    e.Bitmap = a
}(window),
        ...
        a = i.create({
            ...
            constructor: function (t) {
                ...
                if (i.getContext) {
                    ...
                    i.parentNode.insertBefore(this.drawable.domElement, s)
                } else t.draw(this)
            }
        });
    e.DOMElement = a
        ...
        a = function () {
            ...
            return i.create({
                ...
                lineStyle: function (t, e, i, n, r, a) {
                    var s = this,
                        o = s._addAction;
                    return o.call(s, ["lineWidth", s.lineWidth = t || 1]), o.call(s, ["strokeStyle", s.strokeStyle = e || "0"]), o.call(s, ["lineAlpha", s.lineAlpha = i || 1]), void 0 != n && o.call(s, ["lineCap", s.lineCap = n]), void 0 != r && o.call(s, ["lineJoin", s.lineJoin = r]), void 0 != a && o.call(s, ["miterLimit", s.miterLimit = a]), s.hasStroke = !0, s
                    ...
                    return o.hasFill = !0, o._addAction(["fillStyle", o.fillStyle = h])
                }, beginRadialGradientFill: function (t, e, i, n, r, a, o, h) {
                ...
                }, drawRoundRectComplex: function (t, e, i, n, r, a, s, o) {
                    var h = this,
                        l = h._addAction;
                    return l.call(h, ["moveTo", t + r, e]), l.call(h, ["lineTo", t + i - a, e]), l.call(h, ["arc", t + i - a, e + a, a, -Math.PI / 2, 0, !1]), l.call(h, ["lineTo", t + i, e + n - s]), l.call(h, ["arc", t + i - s, e + n - s, s, 0, Math.PI / 2, !1]), l.call(h, ["lineTo", t + o, e + n]), l.call(h, ["arc", t + o, e + n - o, o, Math.PI / 2, Math.PI, !1]), l.call(h, ["lineTo", t, e + r]), l.call(h, ["arc", t + r, e + r, r, Math.PI, 3 * Math.PI / 2, !1]), h
                    ...
                    var a = r._addAction,
                        ...
                        l = h * s,
                        c = h * o;
                    return t += s, e += o, a.call(r, ["moveTo", t + s, e]), a.call(r, ["bezierCurveTo", t + s, e - c, t + l, e - o, t, e - o]), a.call(r, ["bezierCurveTo", t - l, e - o, t - s, e - c, t - s, e]), a.call(r, ["bezierCurveTo", t - s, e + c, t - l, e + o, t, e + o]), a.call(r, ["bezierCurveTo", t + l, e + o, t + s, e + c, t + s, e]), r
                    ...
                    for (t.beginPath(), e = 0; r > e; e++) {
                        var a = n[e],
                            s = a[0],
                            o = a.length > 1 ? a.slice(1) : null;
                        "function" == typeof t[s] ? t[s].apply(t, o) : t[s] = a[1]
                    }
                }, render: function (t, e) {
                    var i = this;
                    t.canvas;
...
function (t) {
    var e = t.Hilo,
        ...
        a = i.create({
            ...
            Mixes: r,
            constructor: function (t) {
                t = t || {}, this.id = this.id || t.id || e.getUid("Text"), a.superclass.constructor.call(this, t), t.font || (this.font = "12px arial"), this._fontHeight = a.measureFontHeight(this.font)
            }, text: null,
            color: "#000",
            textAlign: null,
            textVAlign: null,
            ...
            setFont: function (t) {
                ...
                if (i) {
                    ...
                    for (n = 0, len = s.length; n < len; n++)
                        if (r = s[n], a = t.measureText(r).width, a <= e.maxWidth) c.push({
                            text: r,
                            y: h
                        }), a > o && (o = a), h += l;
                        else {
                            var u, d, f, p = "",
                                v = 0;
                            for (d = 0, wlen = r.length; d < wlen; d++) f = r[d], u = t.measureText(p + f).width, u > e.maxWidth ? (c.push({
                                text: p,
                                y: h
                            }), v > o && (o = v), h += l, p = f) : (v = u, p += f), d == wlen - 1 && (c.push({
                                text: p,
                                y: h
                            }), p !== f && u > o && (o = u), h += l)
                        }
                    ...
                    for (var n = 0; n < c.length; n++) {
                        var r = c[n];
                        e._drawTextLine(t, r.text, m + r.y)
                    }
                }
...
function (t) {
    var e = t.Hilo,
        ...
        a = i.create({
            Extends: n,
            constructor: function (t) {
                t = t || {}, this.id = this.id || t.id || e.getUid("BitmapText"), a.superclass.constructor.call(this, t);
                var i = t.text + "";
            ...
            setText: function (t) {
                ...
                if (e.text != i) {
                    ...
                    return e.width = h, e.height = l, this.setTextAlign(), e
                }
                ...
                createGlyphs: function (t, e, i, n) {
                    var r = t.toString();
                    i = i || r.length, n = n || 1;
                    for (var a = e.width / i, s = e.height / n, o = {}, h = 0, l = t.length; l > h; h++) charStr = r.charAt(h), o[charStr] = {
                        image: e,
                        rect: [a * (h % i), s * Math.floor(h / i), a, s]
                    };
                    return o
                }
            }
...
function (t) {
    var e = t.Hilo,
        ...
        a = i.create({
            Extends: n,
            constructor: function (t) {
                t = t || {}, this.id = this.id || t.id || e.getUid("Button"), a.superclass.constructor.call(this, t), this.drawable = new r(t), this.setState(a.UP)
            }, upState: null,
            overState: null,
            downState: null,
            disabledState: null,
            ...
            setEnabled: function (t) {
                return this.enabled != t && (t ? this.setState(a.UP) : this.setState(a.DISABLED)), this
            }, setState: function (t) {
                if (this.state !== t) {
                    this.state = t, this.pointerEnabled = this.enabled = t !== a.DISABLED;
                    var i;
                    switch (t) {
                    case a.UP:
                        i = this.upState;
        ...
        n = function () {
            function t(t) {
                ...
                if (e instanceof Array)
                    for (var r = 0, a = e.length; a > r; r++) i = e[r], n[r] = {
                        image: t.image,
                        rect: i
                    };
                else
                    for (var s = e.frameWidth, o = e.frameHeight, h = t.width / s | 0, l = t.height / o | 0, c = e.numFrames || h * l, r = 0; c > r; r++) n[r] = {
                        image: t.image,
                        rect: [r % h * s, (r / h | 0) * o, s, o]
                    };
                return n
            }
                ...
                for (var l in i) {
                    if (a = i[l], r(a)) s = n(e[a]);
                        ...
                        for (var c = 0, u = a.length; u > c; c++) {
                            var d, f = a[c];
                            r(f) ? o = n(e[f]) : (d = f.rect, r(d) && (d = e[f.rect]), o = n(d, f)), s[c] = o
                        }
                    } else {
                        s = [];
            ...
            return i.create({
                constructor: function (i) {
                    this._frames = t(i), this._sprites = e(i, this._frames)
                }, _frames: null,
                _sprites: null,
                getFrame: function (t) {
                    var e = this._frames;
                    ...
                    createSpriteFrames: function (t, e, i, n, r, a, s) {
                        ...
                        for (var f = Math.floor(i.width / n), o = 0; o < e.length; o++) {
                            var p = e[o];
                            e[o] = {
                                rect: [n * (p % f), r * Math.floor(p / f), n, r],
                                image: i,
                                duration: s
                            }
                        }
        ...
        n = i.create({
            ...
            start: function (i) {
                if (!this._intervalId) {
                    ...
                    if (i && a) var s = function () {
                            n._tick()
                        },
                        o = function () {
                            n._intervalId = setTimeout(o, r), a(s)
                        };
                    else o = function () {
                        n._intervalId = setTimeout(o, r), n._tick()
                    };
                    o()
                }
            }, stop: function () {
                ...
                if (!this._paused) {
                    ...
                    for (var n = 0, r = i.length; r > n; n++) i[n].tick(e)
                }
...
function (t) {
    var e = t.Hilo,
        i = Array.prototype,
        n = i.slice;
    i.indexOf = i.indexOf || function (t, e) {
        e = e || 0;
        var i, n = this.length;
        if (0 == n || e >= n) return -1;
    ...
    r.bind = r.bind || function (t) {
        ...
        var i = this,
            ...
            a = function () {};
        return a.prototype = i.prototype, e.prototype = new a, e
    }, e.undefined = void 0
}(window),
function (t) {
    var e = t.Hilo,
        i = (e.Class, {
            startDrag: function (t) {
                function i(t) {
                    t.stopPropagation(), a(t), h.off(e.event.POINTER_START, i), h.fire("dragStart", l), h.__dragX = h.x - l.x, h.__dragY = h.y - l.y, o || (o = this.getStage()), o.on(e.event.POINTER_MOVE, r), document.addEventListener(e.event.POINTER_END, n)
                }

                function n(t) {
                    document.removeEventListener(e.event.POINTER_END, n), o && o.off(e.event.POINTER_MOVE, r), h.fire("dragEnd", l), h.on(e.event.POINTER_START, i)
                }

                function r(t) {
                    a(t), h.fire("dragMove", l);
                    var e = l.x + h.__dragX,
                        i = l.y + h.__dragY;
                ...
                function a(t) {
                    l.preX = l.x, l.preY = l.y, l.x = t.stageX, l.y = t.stageY
                }

                function s() {
                    document.removeEventListener(e.event.POINTER_END, n), o && o.off(e.event.POINTER_MOVE, r), h.off(e.event.POINTER_START, i)
                }
                var o, h = this,
                    t = t || [-(1 / 0), -(1 / 0), 1 / 0, 1 / 0],
                    l = {
                    ...
                    d = t[2] == 1 / 0 ? 1 / 0 : c + t[2],
                    f = t[3] == 1 / 0 ? 1 / 0 : u + t[3];
                h.on(e.event.POINTER_START, i), h.stopDrag = s
            }, stopDrag: function () {}
        });
    e.drag = i
}(window),
        ...
        n = function () {
            ...
            return i.create({
                constructor: function (t, e, i, n) {
                    ...
                    r.setProps(e, i), !n.duration && n.time && (r.duration = n.time || 0, r.time = 0)
                }, target: null,
                duration: 0,
                delay: 0,
                paused: !1,
                ...
                setProps: function (t, e) {
                    ...
                    var e = this;
                    return e._startTime = t() + e.delay, e._seekTime = 0, e._pausedTime = 0, e.paused = !1, n.add(e), e
                }, stop: function () {
                    ...
                    var r = this,
                        a = t();
                    return r._startTime = a, r._seekTime = e, r._pausedTime = 0, void 0 !== i && (r.paused = i), r._update(a, !0), n.add(r), r
                }, link: function (t) {
                    var e = this,
                        i = t.delay,
                        r = e._startTime;
                    ...
                    return t.delay = i, t._startTime = a || s ? r + e.duration + i : r + i, e._next = t, n.remove(t), e
                }, _render: function (t) {
                    var e, i = this,
                        n = i.target,
                        r = i._fromProps;
                    ...
                    if (!r.paused || i) {
                        ...
                        if (!(0 > a)) {
                            ...
                            return h ? ((s = r.onComplete) && s.call(r, r), !0) : void 0
                        }
                    }
                }, Statics: {
                    _tweens: [],
                    tick: function () {
                        ...
                        var e = n._tweens;
                        return -1 == e.indexOf(t) && e.push(t), n
                    }, remove: function (t) {
                        if (t instanceof Array) {
        ...
        i = function () {
            ...
            var e = t(null, null, null, null, function (t) {
                ...
                m = t({
                    ...
                    s: .1,
                    config: function (t, e) {
                        m.a = t, m.p = e, m.s = e / (2 * o) * Math.asin(1 / t) || 0
                    }
                }, function (t) {
                    return -(m.a * u(2, 10 * (t -= 1)) * l((t - m.s) * (2 * o) / m.p))
                }, function (t) {
                    return m.a * u(2, -10 * t) * l((t - m.s) * (2 * o) / m.p) + 1
                }, function (t) {
                ...
                _ = t(null, function (t) {
                    ...
                    return (t /= 1) < .36364 ? 7.5625 * t * t : .72727 > t ? 7.5625 * (t -= .54545) * t + .75 : .90909 > t ? 7.5625 * (t -= .81818) * t + .9375 : 7.5625 * (t -= .95455) * t + .984375
                }, function (t) {
        ...
        n = i.create({
            load: function (t) {
                ...
                t.crossOrigin && (i.crossOrigin = t.crossOrigin), i.onload = function () {
                    e.onLoad(i)
                }, i.onerror = i.onabort = e.onError.bind(i), i.src = t.src + (t.noCache ? (-1 == t.src.indexOf("?") ? "?" : "&") + "t=" + +new Date : "")
            }, onLoad: function (e) {
                e = e || t.event;
                var i = e;
    ...
    var e = t.Hilo,
        ...
        n = i.create({
            load: function (e) {
                ...
                l.type = "text/javascript", l.async = !0, l.onload = i.onLoad.bind(i), l.onerror = i.onError.bind(i), l.src = r, e.id && (l.id = e.id), document.getElementsByTagName("head")[0].appendChild(l)
            }, onLoad: function (t) {
                var e = t.target;
                ...
                if (t._currentIndex < i - 1 && t._connections < t.maxConnections) {
                    ...
                    if (a) {
                        var s = a.onLoad,
                            o = a.onError;
                        a.onLoad = function (e) {
                            a.onLoad = s, a.onError = o;
                            var i = s && s.call(a, e) || e.target;
                            t._onItemLoad(n, i)
                        }, a.onError = function (e) {
                            a.onLoad = s, a.onError = o, o && o.call(a, e), t._onItemError(n, e)
                        }, t._connections++
                    }
        ...
        r = function () {
            ...
            return i.create({
                ...
                _init: function () {
                    ...
                    this._buffer = t, this.loaded = !0, this.duration = t.duration, this.fire("load"), this.autoPlay && this._doPlay()
    ...
    var e = t.Hilo,
        ...
        r = {
            ...
            enableAudio: function () {
                ...
                return e || (n.isSupported ? e = new n(t) : i.isSupported && (e = new i(t)), this._audios[t.src] = e), e
    ...
    var e = t.Hilo,
        ...
        n = i.create({
            constructor: function (t) {
                ...
                if (e) {
                    var a, s;
                    r ? (a = Math.min(Math.max(e.x - i.x, r[0]), r[0] + r[2]), s = Math.min(Math.max(e.y - i.y, r[1]), r[1] + r[3])) : (a = .5 * this.width, s = .5 * this.height), i.x = e.x - a, i.y = e.y - s, n && (i.x = Math.min(Math.max(i.x, n[0]), n[0] + n[2]), i.y = Math.min(Math.max(i.y, n[1]), n[1] + n[3]))
                } else i.x = 0, i.y = 0
            }, follow: function (t, e) {
                ...
                s = i.create({
                    constructor: function (t) {
                        ...
                        var x = this.fv / (this.fv + _.z),
                            y = _.x * x,
                            w = -_.y * x;
                        return i ? (i.x = y + this.fx, i.y = w + this.fy, i.z = -_.z, i.scaleX = x, i.scaleY = x, void 0) : {
                            x: y + this.fx,
                            y: w + this.fy,
                            z: -_.z,
                            scale: x
            ...
            var u = {
                ...
                f = i.create({
                    ...
                    constructor: function v(t) {
                        this.id = this.id || t.id || e.getUid("ParticleSystem"), this.emitterX = 0, this.emitterY = 0, this.gx = 0, this.gy = 0, this.totalTime = 1 / 0, this.emitNum = 10, this.emitNumVar = 0, this.emitTime = .2, this.emitTimeVar = 0, this.particle = {}, v.superclass.constructor.call(this, t), this.reset(t)
                    }, Statics: {
                        PROPS: o,
                        PROPS_DEFAULT: u,
                        diedParticles: d
                        ...
                        for (var e = t(this.emitNum, this.emitNumVar) >> 0, i = 0; e > i; i++) this.addChild(p.create(this.particle))
                    }, start: function () {
                ...
                p = i.create({
                    ...
                    constructor: function m(t) {
                        this.id = this.id || t.id || e.getUid("Particle"), m.superclass.constructor.call(this, t), this.init(t)
                    }, onUpdate: function (t) {
                        if (t *= .001, !this._died) {
